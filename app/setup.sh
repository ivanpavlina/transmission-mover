...
if ! env_var_is_positive TRANSMISSION_LOCAL_PORT; then
  log "TRANSMISSION_LOCAL_PORT env variable invalid, must be a positive integer";
  errored=true;
fi
...
init_env_var_to_file DEBUG false;
